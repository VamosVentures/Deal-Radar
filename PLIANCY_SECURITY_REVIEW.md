...
4. **HubSpot OAuth scopes** — are the requested scopes (`crm.objects.{companies,contacts,deals}.{read,write}`, listed in full in §4) appropriately minimal, or should they be narrowed (e.g., companies-only) for an initial rollout?
